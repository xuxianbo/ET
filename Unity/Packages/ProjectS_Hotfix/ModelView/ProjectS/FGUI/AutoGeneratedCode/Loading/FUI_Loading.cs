...
namespace ET
{
    ...
    {	
        ...
        public static ETTask<FUI_Loading> CreateInstanceAsync(Entity parent)
        {
            ETTask<FUI_Loading> tcs = ETTask<FUI_Loading>.Create(true);
    
            CreateGObjectAsync((go) =>
            {
                tcs.SetResult(parent.AddChild<FUI_Loading, GObject>(go));
            });
