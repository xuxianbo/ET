	...
	public class GraphCollision {
		...
		public Vector3 CheckHeight (Vector3 position, out RaycastHit hit, out bool walkable) {
			...
			if (thickRaycast) {
                ...
                if (Physics.Raycast(position + up * fromHeight, -up, out hit, fromHeight + fromHeight, heightMask, QueryTriggerInteraction.Ignore)) {
                    return hit.point;
                }
		...
		public RaycastHit[] CheckHeightAll (Vector3 position, out int numHits) {
			...
			numHits = Physics.RaycastNonAlloc(position+up*fromHeight, -up, hitBuffer, fromHeight + fromHeight, heightMask, QueryTriggerInteraction.Ignore);
