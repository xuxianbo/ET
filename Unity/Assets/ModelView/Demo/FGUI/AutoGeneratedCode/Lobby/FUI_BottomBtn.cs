...
namespace ET
{
    ...
    {	
        ...
        {			
            return EntityFactory.Create<FUI_BottomBtn, GObject>(domain, CreateGObject());
        }
        ...
        public static ETTask<FUI_BottomBtn> CreateInstanceAsync(Entity domain)
        {
            ...
            {
                tcs.SetResult(EntityFactory.Create<FUI_BottomBtn, GObject>(domain, go));
            });
        ...
        {
            return EntityFactory.Create<FUI_BottomBtn, GObject>(domain, go);
        }
