...
namespace ET
{
    ...
    {	
        ...
        {			
            return EntityFactory.Create<FUI_Btn_Registe, GObject>(domain, CreateGObject());
        }
        ...
        public static ETTask<FUI_Btn_Registe> CreateInstanceAsync(Entity domain)
        {
            ...
            {
                tcs.SetResult(EntityFactory.Create<FUI_Btn_Registe, GObject>(domain, go));
            });
        ...
        {
            return EntityFactory.Create<FUI_Btn_Registe, GObject>(domain, go);
        }
