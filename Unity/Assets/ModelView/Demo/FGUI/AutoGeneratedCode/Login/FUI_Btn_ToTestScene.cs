...
namespace ET
{
    ...
    {	
        ...
        {			
            return EntityFactory.Create<FUI_Btn_ToTestScene, GObject>(domain, CreateGObject());
        }
        ...
        public static ETTask<FUI_Btn_ToTestScene> CreateInstanceAsync(Entity domain)
        {
            ...
            {
                tcs.SetResult(EntityFactory.Create<FUI_Btn_ToTestScene, GObject>(domain, go));
            });
        ...
        {
            return EntityFactory.Create<FUI_Btn_ToTestScene, GObject>(domain, go);
        }
